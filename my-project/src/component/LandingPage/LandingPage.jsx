...
const LandingPage = () => {
  const backgroundImage = window.innerWidth >= 768 ? bgMono : bgMono2;
  return (
    <div className='h-screen w-screen md:px-[40px] bg-slate-500 text-yellow-500 flex-row bg-no-repeat bg-screen flex' style={{backgroundImage: `url(${backgroundImage})`}}>
