    ...
    <div className='py-[50px] px-[20px] md:px-[50px] flex flex-col md:flex-row gap-10 bg-gradient-to-r from-yellow-300 to-yellow-600 w-full rounded-full mx-auto' style={{ maxWidth: '95%' }}>
      <div className="flex flex-col justify-center items-center md:justify-start md:items-start md:w-[50%] gap-[20px]">
        <div className='text-center md:text-left w-full'>
          <h1 className='text-[40px] font-bold text-center'>Vishwakarma</h1>
        ...
        <img src={imageTeam} className='h-[200px] md:hidden rounded-full transition-transform duration-300 ease-in-out hover:scale-110' />
      </div>
      <img src={imageTeam} className='h-[350px] md:flex hidden mx-auto my-auto rounded-full transition-transform duration-300 ease-in-out hover:scale-110' />
    </div>
  );
}
