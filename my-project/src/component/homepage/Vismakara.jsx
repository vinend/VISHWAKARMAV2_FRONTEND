    ...
    <div className='py-[50px] px-[50px] flex flex-row gap-10 bg-gradient-to-r from-yellow-300 to-yellow-600 w-full'>
        <div className="flex flex-col justify-center md:justify-start md:items-start items-center md:w-[50%] gap-[10px]">
          <div className='gap-[5px]'>
            <h1 className='text-[50px] font-bold text-center md:hidden'>Vishwa</h1>
            <h1 className='text-[50px] font-bold text-center md:hidden'>Karma</h1>
            <h1 className='text-[50px] font-bold md:block hidden'>Vishwakarma</h1>
          </div>
          <img src={imageTeam} className='h-[200px] md:hidden rounded transition-transform duration-300 ease-in-out hover:scale-110'/>
